...
import 'package:markets/src/pages/CalorieCalculator.dart';
...
import 'src/pages/colories.dart';
  ...
  static Route<dynamic> generateRoute(RouteSettings settings) {
    ...
    switch (settings.name) {
      ...
      case '/CalorieCalculator':
        return MaterialPageRoute(builder: (_) => CalorieCalculator());
      ...
      case '/colories':
        return MaterialPageRoute(builder: (_) => ColoriesFit());
      default:
